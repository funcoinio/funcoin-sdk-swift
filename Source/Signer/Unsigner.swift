...
// FUNCOIN Transaction Unsigner for recovering tx and public key from a signed tx.
public struct Unsigner {
    ...
    public func unsign(signed: String) throws -> UnsignedTransaction {
        ...
        let unverifiedTransaction = try ethUnverifiedTransaction(serializedData: data)
...
public struct UnsignedTransaction {
    ...
    init(tx: ethTransaction, publicKey: Data) {

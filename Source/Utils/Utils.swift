...
public struct Utils {
    public static func getQuotaPrice(funcoin: FUNCOIN) throws -> BigUInt {
        let result = try ContractCall.request(.getQuotaPrice, funcoin: funcoin)
...
extension Utils {
    ...
    struct ContractCall {
        ...
        static func request(_ requestType: RequestType, funcoin: FUNCOIN) throws -> String {
            return try funcoin.rpc.call(request: requestType.rawValue)
        }
    }
}

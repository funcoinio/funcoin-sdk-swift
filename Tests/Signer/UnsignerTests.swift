...
class UnsignerTests: XCTestCase {
    ...
    func testUnsignContent() {
        let unsigned = try! Unsigner().unsign(signed: "")
        XCTAssertEqual(unsigned.transaction.quota, 1_000_000)
    }

    func testUnsignBadData() {
        do {
            let _ = try Unsigner().unsign(signed: "oh no")
